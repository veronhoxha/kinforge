...
describe('MemberDataDialog component', () => {
  ...
  test('should render the MemberDataDialog component with user data', () => {
    render( 
  ...
  test('should render the MemberDataDialog component without user data', () => {
    render(<MemberDataDialog open={true} onClose={mockOnClose} user={null} />);

    expect(screen.getByText('Searched person data')).toBeInTheDocument();
  });

  test('should call onClose when the Close button is clicked', () => {
    render(<MemberDataDialog open={true} onClose={mockOnClose} user={user} />);
